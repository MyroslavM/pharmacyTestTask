...
@section('title', trans("allTranslate.editing_clinic"))
@section('breadCrumb', Breadcrumbs::render('editClinic',$clinic))
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    @lang('allTranslate.editing_clinic')
                </h3>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$clinic->name}}" name="name" placeholder="@lang('allTranslate.name_clinic')">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$clinic->address}}" name="address" placeholder="@lang('allTranslate.address')">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-none">
                        <div class="form-group">
                            ...
                            <input class="form-control kt_timepicker" readonly="" value="{{$clinic->start_time}}" name="start_time" placeholder="@lang('allTranslate.start_day')" type="text">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-none">
                        <div class="form-group">
                            ...
                            <input class="form-control kt_timepicker" readonly="" value="{{$clinic->end_time}}" name="end_time" placeholder="@lang('allTranslate.end_day')" type="text">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="color" name="color" value="{{$clinic->color}}" id="example-color-input">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
