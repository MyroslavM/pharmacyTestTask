...
@section('title', trans("allTranslate.Edit_marketing"))
@section('breadCrumb', Breadcrumbs::render('editMarketing', $marketing))
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    @lang('allTranslate.Edit_marketing')
                </h3>
            </div>
        ...
        <form class="formAdd kt-form">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$marketing->name}}" name="name" placeholder="@lang('allTranslate.Name_marketing')">
            ...
            <div class="kt-portlet__foot">
                <div class="kt-portlet__head-actions justify-content-end d-flex">
                    <a href="{{ route('adminMarketings') }}" class="btn btn-secondary btn-elevate btn-icon-sm"><i class="fa fa-window-close"></i> <span class="d-m-n">@lang('allTranslate.cancel_btn')</span></a>
                    &nbsp;
