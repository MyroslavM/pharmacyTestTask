                ...
                <div class="kt-portlet__body">
                    <table class="table table-striped- table-bordered table-hover table-checkable table-responsive-md">
                        ...
                        <tr>
                            ...
                            <td>24EERCDS</td>
                            <td>Парацетамол</td>
                            <td>ПарГрупп Интернешл</td>
                            <td>18</td>
                            <td>326 грн</td>
                            <td>390грн</td>
                            <td class="text-right d-flex align-items-center justify-content-end">
                                <a href="#writeProduct" data-toggle="modal" class="btn btn-sm btn-success  btn-elevate btn-icon d-flex "><i class="la la-money"></i></a>
                                &nbsp;
                                <a href="{{route('productsEdit')}}" class="btn btn-sm btn-outline-brand btn-elevate btn-icon d-flex "><i class="la la-edit"></i></a>
                                &nbsp;
                                <a href="#deleteProduct" data-toggle="modal" class="btn btn-sm btn-danger btn-icon d-flex  "><i class="la la-trash"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>1</td>
                            ...
                            <td>390грн</td>
                            <td class="text-right d-flex align-items-center justify-content-end">
                                <a href="" class="btn btn-sm btn-success  btn-elevate btn-icon d-flex "><i class="la la-money"></i></a>
                                &nbsp;
...
@push('modals')
    ...
    <div class="modal fade" id="writeProduct" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Списать <b>парацетамол</b></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" placeholder="Введите  ">
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="form-group">
                        <label>Город</label>
